...
func (c *accountServiceClient) PublicDetails(ctx context.Context, in *Id, opts ...grpc.CallOption) (*AccountPublicInfos, error) {
	out := new(AccountPublicInfos)
	err := c.cc.Invoke(ctx, "/proto.AccountService/PublicDetails", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountServiceClient) PrivateDetails(ctx context.Context, in *Id, opts ...grpc.CallOption) (*AccountPrivateInfos, error) {
	out := new(AccountPrivateInfos)
	err := c.cc.Invoke(ctx, "/proto.AccountService/PrivateDetails", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountServiceClient) Edit(ctx context.Context, in *AccountPrivateInfos, opts ...grpc.CallOption) (*AccountPrivateInfos, error) {
	out := new(AccountPrivateInfos)
...
func (c *accountServiceClient) GenerateToken(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Token, error) {
	out := new(Token)
...
func (UnimplementedAccountServiceServer) PrivateDetails(context.Context, *Id) (*AccountPrivateInfos, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PrivateDetails not implemented")
}
func (UnimplementedAccountServiceServer) Edit(context.Context, *AccountPrivateInfos) (*AccountPrivateInfos, error) {
...
func (UnimplementedAccountServiceServer) GenerateToken(context.Context, *Id) (*Token, error) {
...
func _AccountService_PublicDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Id)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).PublicDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AccountService/PublicDetails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).PublicDetails(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}

func _AccountService_PrivateDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Id)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).PrivateDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AccountService/PrivateDetails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).PrivateDetails(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AccountService_Edit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).Edit(ctx, req.(*AccountPrivateInfos))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AccountService_GenerateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).GenerateToken(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AccountService_PublicDetails_Handler,
		},
		{
			MethodName: "PrivateDetails",
			Handler:    _AccountService_PrivateDetails_Handler,
		},
		{
			MethodName: "Edit",
