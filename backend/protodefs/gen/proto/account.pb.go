...
var file_account_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x46, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x41, 0x63,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x42, 0x09,
...
var file_account_proto_goTypes = []interface{}{
	(*GetAccountByIdRequest)(nil), // 0: proto.GetAccountByIdRequest
	(*NewAccountLocation)(nil),    // 1: proto.NewAccountLocation
	(*NewAccountRequest)(nil),     // 2: proto.NewAccountRequest
	(*LocationDetails)(nil),       // 3: proto.LocationDetails
	(*AccountDetails)(nil),        // 4: proto.AccountDetails
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_account_proto_depIdxs = []int32{
	5, // 0: proto.NewAccountRequest.birth_date:type_name -> google.protobuf.Timestamp
	1, // 1: proto.NewAccountRequest.location:type_name -> proto.NewAccountLocation
	5, // 2: proto.AccountDetails.birth_date:type_name -> google.protobuf.Timestamp
	3, // 3: proto.AccountDetails.location:type_name -> proto.LocationDetails
	5, // 4: proto.AccountDetails.created_at:type_name -> google.protobuf.Timestamp
	5, // 5: proto.AccountDetails.updated_at:type_name -> google.protobuf.Timestamp
	2, // 6: proto.AccountService.Create:input_type -> proto.NewAccountRequest
	0, // 7: proto.AccountService.GetById:input_type -> proto.GetAccountByIdRequest
	4, // 8: proto.AccountService.Create:output_type -> proto.AccountDetails
	4, // 9: proto.AccountService.GetById:output_type -> proto.AccountDetails
